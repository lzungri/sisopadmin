...
/**
 * Model para los casos de uso de Administración que generan reportes.
 * Como no se tiene herencia múltiple se implementa la interfaz y se compone de un Report.
 *
 * @author Leandro
 */
public abstract class AdminReportBaseUseCaseModel extends AdminBaseUseCaseModel implements ReportUseCaseModel {
